...
export default function ContactPage() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[var(--color-primary)]/5 via-[var(--color-primary-light)]/10 to-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="space-y-8">
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-primary-dark)] rounded-2xl shadow-xl p-8 text-white"
                >
                  ...
                  <button className="w-full bg-white font-semibold py-3 px-6 rounded-lg hover:bg-gray-50 transition-all duration-300 transform hover:-translate-y-0.5 shadow-lg hover:shadow-xl border border-gray-200">
                    <span className="text-[var(--color-primary)] font-semibold">Schedule Demo</span>
                  </button>
                </motion.div>
