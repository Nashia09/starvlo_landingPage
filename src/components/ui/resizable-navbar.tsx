...
export const MobileNav = ({ children, className, visible }: MobileNavProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-50 mx-auto flex w-full max-w-sm flex-col items-center justify-between bg-transparent px-4 py-3 lg:hidden",
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className={cn(
            "absolute left-4 right-4 top-20 z-50 flex max-w-sm mx-auto flex-col items-start justify-start gap-3 rounded-xl bg-white px-6 py-6 shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] dark:bg-neutral-950 border border-gray-200/20",
            className,
          )}
        >
          {children}
...
export const MobileNavToggle = ({
  ...
  return (
    <button
      onClick={onClick}
      className="relative z-[60] p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200 lg:hidden flex items-center justify-center bg-white shadow-sm border border-gray-200 min-w-[44px] min-h-[44px]"
      aria-label={isOpen ? "Close menu" : "Open menu"}
      type="button"
    >
      {isOpen ? (
        <IconX className="w-6 h-6 text-gray-900 dark:text-white stroke-2 flex-shrink-0" />
      ) : (
        <IconMenu2 className="w-6 h-6 text-gray-900 dark:text-white stroke-2 flex-shrink-0" />
      )}
    </button>
  );
};
