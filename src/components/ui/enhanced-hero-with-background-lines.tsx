...
export interface EnhancedHeroWithBackgroundLinesProps {
  title: string;
  description?: string;
  backLink?: string;
  backLinkText?: string;
...
export const EnhancedHeroWithBackgroundLines = ({
  title,
  description,
  backLink,
  backLinkText,
  ...
  children,
}: EnhancedHeroWithBackgroundLinesProps) => {
  return (
    <BackgroundLines
      className="relative w-full h-auto min-h-screen bg-[#0A0F18] dark:bg-[#0A0F18]"
    >
