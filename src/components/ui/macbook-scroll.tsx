  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative w-[95vw] max-w-[84rem] rounded-[2rem] bg-black p-3 shadow-2xl [perspective:800px]"
        onClick={() => {
      ...
      >
        ...
        <div className="relative h-full w-full rounded-[1.7rem] bg-[#111] overflow-hidden">
