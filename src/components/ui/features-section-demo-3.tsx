    ...
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        <h4 className="text-3xl lg:text-5xl lg:leading-tight max-w-5xl mx-auto text-center tracking-tight font-medium text-black dark:text-white">
          Identify your website visitors and turn them into leads
        </h4>

        <p className="text-sm lg:text-base max-w-2xl my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          Stop guessing who&apos;s visiting your website. Our platform reveals the companies behind the clicks, allowing you to convert anonymous traffic into qualified leads.
        </p>
      </div>
...
export const SkeletonTwo = () => {
  const images = [
    "https://images.unsplash.com/photo-1573167243872-43c6433b9d40?q=80&w=2069&auto=format&fit=crop",
